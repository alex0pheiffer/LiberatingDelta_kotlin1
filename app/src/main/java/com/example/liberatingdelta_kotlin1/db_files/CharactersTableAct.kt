...
import com.example.liberatingdelta_kotlin1.db_files.adapter_classes.characters_adapter
import com.google.android.material.floatingactionbutton.FloatingActionButton

class CharactersTableAct : AppCompatActivity() {
    private var rpgViewModel: RPG_ViewModel? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_values_table)
        val recyclerView = findViewById<RecyclerView>(R.id.recyclerview)
        val adapter = characters_adapter(this)
        ...
        fab.setOnClickListener {
            val intent = Intent(this@CharactersTableAct, dbCheckerActivity::class.java)
